...
export const BIZ_SEED_SOURCES: BizSeedSource[] = [
  ...
  { name: "Reddit r/SaaS", url: "https://old.reddit.com/r/SaaS/.rss", tier: 2, fetch_interval_minutes: 4320 },
  { name: "Reddit r/SideProject", url: "https://old.reddit.com/r/SideProject/.rss", tier: 2, fetch_interval_minutes: 4320 },
  { name: "Hacker News 搞钱", url: "https://hnrss.org/newest?q=AI+(MRR+OR+revenue+OR+SaaS)", tier: 2, fetch_interval_minutes: 4320 },
  { name: "宝玉的分享", url: "https://baoyu.io/feed.xml", tier: 2, fetch_interval_minutes: 4320 },
];
