...
export const articles: Article[] = [
  { slug: 'opc-asset-consciousness', type: 'Essay', title: '不功利沟通：聊聊一人公司:资产意识(1)', excerpt: '一人公司这种模式，现在越来越值得认真对待。人生不能只有一份工资，还要有一点真正属于自己的资产。从选人群到建信任，从做产品到养复利，一篇文章讲透一人公司的底层逻辑。', tags: ['一人公司', 'OPC', '资产意识', '独立创业'], date: '2026-05-14', read: '25 min', premium: false, body: [] },
