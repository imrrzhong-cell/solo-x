...
评估标准：
1. **影响力** — 对 AI 行业的实际影响程度。揭示新型商业模式、独立开发者变现案例、具有颠覆性视角的文章应获得更高影响力评分。
2. **新颖性** — 信息的新鲜度和独特性
3. **深度** — 技术或分析的深度
4. **实用性** — 对从业者的参考价值。包含可复用的工程实践、产品策略、增长方法论的内容应获得更高实用性评分。
5. **时效性** — 发布时间越近分数越高。超过 7 天的内容应显著扣分。
...
- is_featured: boolean，score >= 65 且发布时间在 7 天以内为 true，否则为 false
- 发布日期如果超过 7 天，score 应自动降低 30 分以上
